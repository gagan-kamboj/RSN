...
<div class="bannerbnr-2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <button class="buttondarkpink 1">Experienced Team</button>  
                <h1 style="margin-top:10px;"><?=$bannerteam['Heading'];?></h1>
                <p><?=$bannerteam['Content'];?> </p>
                <a href="#"> More about us	&#8594</button></a>
            </div>
    ...
    <!-- Industry start -->
     <div class="container industry-section" style="display:none;">
        <div class="row">
             <?php 
             $a = 0;
             while($row = mysqli_fetch_array($Industries)){ ?>
            <div class="col-md-4">
                <div class="service-tabs<?=$a;?> industry-tabs">
                     <!--<a href="single-industry.php?industry=" class="zoom d-block">-->
                 <img class="img-fluide<?=$a;?>" src="admin/dashboard/assets/images/industry/<?=$row['Icon'];?>" alt=""/>
                <h4 class="colorr<?=$a;?>"><?=$row['Title'];?></h4>
                <!--<p></p></a>-->
                </div>
            </div>
               <?php $a++;} ?>
